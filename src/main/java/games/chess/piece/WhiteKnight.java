 ...
 */
public class WhiteKnight extends AbstractPieceChessGeneral {

  public WhiteKnight(String name, int y, int x) {
    super.name = name;
    super.y = y;
    super.x = x;
  }
  ...
  public boolean validate(IPiece iPiece, int toY, int toX,
      IPiece[][] board,
  ...
  public String getClassName() {
    return WhiteKnight.class.getName();
  }
